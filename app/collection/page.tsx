...
const Collection: React.FC = () => {
  return (
    <div className="overflow-hidden w-full h-full p-0 md-min:p-10 gap-20 bg-gray-50">
      <BoxDescription name="اطلاعیه ها" Icon={DangerSquare}>
        <h1 className="text-right text-orange-300">
          استخر به دلیل تعمیرات، از تاریخ 00 / 00 / 0 0 تا تاریخ 00 / 00 / 0 0
          تعطیل می‌باشد
        </h1>
      </BoxDescription>
      <Card
      ...
      <BoxMuliCarousel SLIDES={[]} DivderName={""} />
    </div>
  );
};
