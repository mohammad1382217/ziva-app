...
function HeaderFilterBox({ name, Icon, isFilter }: { name: string, Icon: any, isFilter?: boolean }) {
  return (<div className="flex flex-row-reverse  gap-6 justify-center items-center ">
    ...
    {isFilter && <ButtonZiva className="p-0 gap-[2px] min-w-[66px] w-[57px] h-[20px]" them="default" buttonTextClassName="text-10 font-semibold text-Error-500" variant="flat" type="button" buttonText="حذف همه" leftIcon={<CloseSquare size={10} color="#F04438" />} />}
