...
const inputDateZiva: React.FC<InputType> = ({
  ...
  return (
    <DatePicker
      ...
      inputClass={`outline-0 w-full bg-white h-11 border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 disabled:text-slate-600 disabled:bg-white disabled:border-slate-300 disabled:cursor-not-allowed select-none`}
