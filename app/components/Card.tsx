...
import { Heart, Map, MapPointWave, Reply2, Sale } from "solar-icon-set";
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-row justify-between items-center">
                        ...
                        <div className="flex justify-center items-center gap-1">
                            ...
                            {Verticalable && <div className="rounded-lg gap-[3px] flex w-10 h-5 flex-row justify-center items-center bg-amber-400">
